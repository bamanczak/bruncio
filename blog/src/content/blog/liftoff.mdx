...
<div class="min-[768px]:float-right flex flex-col justify-center items-center ml-1 mb-1">
    <Image src={liftoff} alt="Picture of a rocket launch" width={300} class="border-4 border-black" />
</div>
<br/>
